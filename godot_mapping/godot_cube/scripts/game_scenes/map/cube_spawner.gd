...
func game_loop() -> void:
	...
	if not is_generated:
		...
		scheduled_bloc(classic_bloc, 24.75, 0, [0.0, 3.0], 8.0, 3)
		...
		scheduled_bloc(classic_bloc, 27.50, 1, [-2.0, 3.0], 8.0, 2)
		...
		scheduled_bloc(classic_bloc, 33.75, 0, [2.0, 0.5], 8.0, 2)
		scheduled_bloc(disappear_bloc, 33.75, 1, [0.0, 0.5], 8.0)
		scheduled_bloc(classic_bloc, 33.75, 1, [2.0, 1.75], 8.0, 1)
		scheduled_bloc(classic_bloc, 33.75, 1, [-2.0, 3.0], 8.0, 2)
		scheduled_bloc(classic_bloc, 36.50, 0, [-2.0, 3.0], 8.0, 2)
		scheduled_bloc(classic_bloc, 36.50, 0, [0.0, 1.75], 8.0, 1)
		scheduled_bloc(classic_bloc, 36.50, 0, [2.0, 0.5], 8.0, 2)
		scheduled_bloc(classic_bloc, 36.50, 1, [2.0, 3.0], 8.0, 2)
		scheduled_bloc(classic_bloc, 36.50, 1, [0.0, 1.75], 8.0, 1)
		scheduled_bloc(classic_bloc, 36.50, 1, [-2.0, 0.5], 8.0, 2)
		scheduled_bloc(bonus_bloc, 40.25, 0, [0.0, 1.75], 8.0)
		scheduled_bloc(bomb_bloc, 40.25, 0, [-2.0, 0.5], 8.0)
		scheduled_bloc(bomb_bloc, 40.25, 0, [2.0, 3.0], 8.0)
		scheduled_bloc(bonus_bloc, 40.25, 1, [0.0, 1.75], 8.0)
		scheduled_bloc(bomb_bloc, 40.25, 1, [2.0, 0.5], 8.0)
		scheduled_bloc(bomb_bloc, 40.25, 1, [-2.0, 3.0], 8.0)
		scheduled_bloc(classic_bloc, 42.50, 0, [-2.0, 3.0], 8.0, 3)
		scheduled_bloc(classic_bloc, 42.50, 0, [2.0, 0.5], 8.0, 3)
		scheduled_bloc(classic_bloc, 42.50, 1, [2.0, 3.0], 8.0, 3)
		...
		scheduled_bloc(classic_bloc, 45.50, 0, [0.0, 0.5], 8.0, 1)
		scheduled_bloc(splash_bloc, 45.50, 1, [2.0, 1.75], 8.0)
		scheduled_bloc(classic_bloc, 45.50, 1, [-2.0, 3.0], 8.0, 2)
		scheduled_bloc(classic_bloc, 45.50, 1, [0.0, 0.5], 8.0, 1)
		...
		scheduled_bloc(bomb_bloc, 48.50, 0, [2.0, 3.0], 8.0)
		scheduled_bloc(disappear_bloc, 48.50, 1, [0.0, 1.75], 8.0)
		scheduled_bloc(bomb_bloc, 48.50, 1, [2.0, 0.5], 8.0)
		scheduled_bloc(bomb_bloc, 48.50, 1, [-2.0, 3.0], 8.0)
		scheduled_bloc(classic_bloc, 53.25, 0, [-2.0, 0.5], 8.0, 1)
		scheduled_bloc(classic_bloc, 53.25, 0, [2.0, 3.0], 8.0, 3)
		scheduled_bloc(classic_bloc, 53.25, 1, [2.0, 0.5], 8.0, 1)
		scheduled_bloc(classic_bloc, 53.25, 1, [-2.0, 3.0], 8.0, 3)
		scheduled_bloc(bonus_bloc, 54.50, 0, [-2.0, 3.0], 8.0)
		scheduled_bloc(bonus_bloc, 55.0, 1, [2.0, 3.0], 8.0)
		scheduled_bloc(bomb_bloc, 57.25, 0, [0.0, 3.0], 8.0)
		scheduled_bloc(classic_bloc, 57.25, 0, [-2.0, 1.75], 8.0, 2)
		scheduled_bloc(classic_bloc, 57.25, 0, [2.0, 0.5], 8.0, 1)
		scheduled_bloc(bomb_bloc, 57.25, 1, [0.0, 0.5], 8.0)
		scheduled_bloc(classic_bloc, 57.25, 1, [2.0, 1.75], 8.0, 2)
		scheduled_bloc(classic_bloc, 57.25, 1, [-2.0, 3.0], 8.0, 1)
		scheduled_bloc(splash_bloc, 59.50, 0, [0.0, 1.75], 8.0)
		scheduled_bloc(classic_bloc, 59.50, 0, [-2.0, 3.0], 8.0, 3)
		scheduled_bloc(classic_bloc, 59.50, 0, [2.0, 0.5], 8.0, 1)
		scheduled_bloc(splash_bloc, 59.50, 1, [0.0, 1.75], 8.0)
		scheduled_bloc(classic_bloc, 59.50, 1, [2.0, 3.0], 8.0, 3)
		scheduled_bloc(classic_bloc, 59.50, 1, [-2.0, 0.5], 8.0, 1)
		...
		scheduled_bloc(bomb_bloc, 66.00, 0, [2.0, 3.0], 8.0)
		scheduled_bloc(disappear_bloc, 66.00, 1, [2.0, 1.75], 8.0)
		scheduled_bloc(bomb_bloc, 66.00, 1, [0.0, 0.5], 8.0)
		scheduled_bloc(bomb_bloc, 66.00, 1, [-2.0, 3.0], 8.0)
		scheduled_bloc(classic_bloc, 67.25, 0, [-2.0, 3.0], 8.0, 3)
		scheduled_bloc(classic_bloc, 67.25, 0, [2.0, 0.5], 8.0, 3)
		scheduled_bloc(classic_bloc, 67.25, 1, [2.0, 3.0], 8.0, 3)
		scheduled_bloc(classic_bloc, 67.25, 1, [-2.0, 0.5], 8.0, 3)
		...
		scheduled_bloc(bonus_bloc, 68.75, 0, [-2.0, 1.75], 8.0)
		scheduled_bloc(bonus_bloc, 68.75, 1, [2.0, 1.75], 8.0)

		# Phase 4
		scheduled_bloc(classic_bloc, 71.25, 0, [-2.0, 1.75], 8.0, 1)
		scheduled_bloc(classic_bloc, 71.25, 0, [2.0, 0.5], 8.0, 1)
		scheduled_bloc(classic_bloc, 71.25, 1, [2.0, 1.75], 8.0, 1)
		scheduled_bloc(classic_bloc, 71.25, 1, [-2.0, 0.5], 8.0, 1)
		...
		scheduled_bloc(classic_bloc, 80.25, 0, [2.0, 3.0], 8.0, 2)
		scheduled_bloc(classic_bloc, 80.25, 1, [2.0, 1.75], 8.0, 1)
		scheduled_bloc(classic_bloc, 80.25, 1, [-2.0, 3.0], 8.0, 2)
		scheduled_bloc(classic_bloc, 83.75, 0, [0.0, 3.0], 8.0, 1)
		scheduled_bloc(classic_bloc, 83.75, 0, [-2.0, 0.5], 8.0, 2)
		scheduled_bloc(classic_bloc, 83.75, 1, [0.0, 0.5], 8.0, 1)
		scheduled_bloc(classic_bloc, 83.75, 1, [2.0, 3.0], 8.0, 2)
